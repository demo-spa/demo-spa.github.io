...
const catalogTemplate = (recipes, page, pages, search, onSubmitFormHandler) => html`
<h2>Catalog</h2>
<div>
    <form @submit=${onSubmitFormHandler}>
        <input name="search" type="text" .value=${search}>
        <button>Search</button>
    </form>
</div>
<div id="subcatalog">
    ${subtemplate(recipes, page,search, pages)} 
</div>
`;

const subtemplate = (recipes, page,search, pages) => html`
        <div>
